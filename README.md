...
```Bash  
python train.py --exp_name 'dogs' --code_size 32 --triplet_margin 8 --dataset_name 'Stanford_Dogs'
```  
## Result
...
CUDA_VISIBLE_DEVICES=4 python train.py --exp_name 'margin' --code_size 64 --triplet_margin 8 --dataset_name 'Stanford_Dogs' --model resnet18